      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <button *ngShow="cloud9.status == 'Offline'" type="button" class="btn btn-default" (click)="startCloud9()">Start Cloud9</button>
            <button *ngShow="cloud9.status == 'Online'" type="button" class="btn btn-default" (click)="stopCloud9()">Stop Cloud9</button>
