System.register(["angular2/core", "../models/team", "./dev.component", "../models/pairing", "../models/person"], function(exports_1) {
        ...
        execute: function() {
            Teams = (function () {
                ...
                Teams.prototype.generatePairs = function () {
                    ...
                    var v5 = this.teams.filter(function (f) { return f.name === "V5" || f.name === "Foosballerz"; })[0];
