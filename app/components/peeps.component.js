System.register(["angular2/core", "./dev.component"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            Peeps = (function () {
                ...
                Peeps.prototype.relayTeamSwitch = function (event) {
                    this.onSwitchTeam.emit(event);
                };
                Peeps = __decorate([
                    core_1.Component({
                        styles: [],
                        selector: "peeps-section",
            ...
            exports_1("Peeps", Peeps);
        }
    }
});
//# sourceMappingURL=peeps.component.js.map